...
import 'package:admin_app/features/management/screens/project_request_detail_screen.dart';
import 'package:admin_app/features/management/services/project_service.dart';

class ProjectsRequestList extends StatefulWidget {
  final String query;
  const ProjectsRequestList({super.key, required this.query});

  @override
  State<ProjectsRequestList> createState() => _ProjectsRequestListState();
}

class _ProjectsRequestListState extends State<ProjectsRequestList> {
  final _svc = ProjectService();
  late Future<List<ProjectRequestItem>> _future;

  @override
  void initState() {
    super.initState();
    _future = _svc.fetchProjectsRequest();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ProjectRequestItem>>(
      future: _future,
            ...
            return ListTile(
              ...
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => ProjectRequestDetailScreen(project: p),
                  ),
                );
